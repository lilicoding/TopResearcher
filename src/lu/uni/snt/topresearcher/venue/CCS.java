...
public class CCS extends Conf
{
	...
	public CCS(String name, int lastNYears) {
	...
	{	
		String venueName = "ccs";
		
		Utils.toHtml_Fulllist(new CCS(venueName).toYearItems(), venueName);
		
		Utils.toHtml_Statistic(new CCS(venueName).rank(), new CCS(venueName, 10).rank(), new CCS(venueName, 5).rank(), venueName);
	}
