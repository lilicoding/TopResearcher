...
public class USS extends Conf
{
	...
	public USS(String name, int lastNYears) {
	...
	{	
		String venueName = "uss";
		
		Utils.toHtml_Fulllist(new USS(venueName).toYearItems(), venueName);
		
		Utils.toHtml_Statistic(new USS(venueName).rank(), new USS(venueName, 10).rank(), new USS(venueName, 5).rank(), venueName);
	}
