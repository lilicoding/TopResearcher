...
public class OOPSLA extends Conf
{
	...
	public OOPSLA(String name, int lastNYears) {
		super(name, lastNYears);
	}
	
	public OOPSLA(String name) {
		super(name);
	}

	public static void main(String[] args) 
	{	
		String venueName = "oopsla";
		
		Utils.toHtml_Fulllist(new OOPSLA(venueName).toYearItems(), venueName);
		
		Utils.toHtml_Statistic(new OOPSLA(venueName).rank(), new OOPSLA(venueName, 10).rank(), new OOPSLA(venueName, 5).rank(), venueName);
	}
