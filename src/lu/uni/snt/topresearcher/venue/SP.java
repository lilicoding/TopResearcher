...
public class SP extends Conf
{
	...
	public SP(String name, int lastNYears) {
	...
	{	
		...
		Utils.toHtml_Fulllist(new SP(venueName).toYearItems(), venueName);
		
		Utils.toHtml_Statistic(new SP(venueName).rank(), new SP(venueName, 10).rank(), new SP(venueName, 5).rank(), venueName);
	}
