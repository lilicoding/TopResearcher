...
public class ASE extends Conf
{
	...
	public ASE(String name, int lastNYears) {
		super(name, lastNYears);
	}
	
	public ASE(String name) {
		super(name);
	}

	public static void main(String[] args) 
	{	
		String venueName = "ase";
		
		Utils.toHtml_Fulllist(new ASE(venueName).toYearItems(), venueName);
		
		Utils.toHtml_Statistic(new ASE(venueName).rank(), new ASE(venueName, 10).rank(), new ASE(venueName, 5).rank(), venueName);
	}
